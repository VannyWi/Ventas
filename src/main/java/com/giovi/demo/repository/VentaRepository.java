...
@Query("SELECT SUM(v.montoTotal) FROM Venta v WHERE v.fecha BETWEEN :inicio AND :fin")
    ...
    // CORREGIDO: Suma DINERO por método de pago (Global)
    ...
    // CORREGIDO: Suma DINERO por método de pago (Específico Vendedor)
    // Cambiamos el nombre a 'sumar...' para ser consistentes
